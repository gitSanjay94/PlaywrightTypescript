...
test('Create PATCH API Request', async ({ request }) => {
    ...
    const postAPIRequest = await getPOSTAPIRequestBody(firstName, lastName, totalPrice, true,
        "Travelling", "2012-12-12", "2011-11-11");
    ...
    expect(jsonPOSTAPIResponse.booking.bookingdates.checkin).toBe('2012-12-12');
    expect(jsonPOSTAPIResponse.booking.bookingdates.checkout).toBe('2011-11-11');
